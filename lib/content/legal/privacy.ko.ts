  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "paragraph",
          text: "당사는 로그인 상태 유지를 위하여 필수 쿠키를 사용합니다. 이 쿠키는 사이트 작동에 반드시 필요하므로 항상 활성화되어 있습니다. 또한 당사는 사이트가 어떻게 이용되는지 집계 수준에서 파악하기 위하여 Google Analytics(GA4)를 사용하며, 이 과정에서 분석 쿠키가 설정됩니다. 분석 도구는 귀하가 동의한 경우에만 로드됩니다. 첫 방문 시 배너가 귀하의 선택을 묻고, 귀하가 동의하기 전에는 분석과 관련된 어떠한 것도 실행되지 않습니다. 귀하는 페이지 하단의 **쿠키 설정**을 통하여 언제든지 선택을 변경하거나 철회할 수 있습니다.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Google Analytics** — 집계 수준의 이용 분석.",
          ],
        },
        {
          kind: "paragraph",
          text: "이들 제공업체 중 일부는 미국에 소재하거나 미국에서 데이터를 처리합니다. 개인정보가 영국/EEA 밖으로 이전되는 경우, 표준계약조항(Standard Contractual Clauses)과 같은 적절한 보호 조치에 의하여 보호됩니다. 처리업체 전체 목록과 이전 메커니즘은 법률 검토를 통하여 확정될 예정입니다.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: "paragraph",
          text: "당사는 귀하가 계정을 보유하는 동안, 그리고 그 이후에도 법률·세무·회계상의 이유로 보관이 요구되는 기간 동안 계정, 프로필 및 결제 기록을 보관합니다. 귀하가 게시한 공개 콘텐츠는 귀하가 삭제하거나 계정을 폐쇄할 때까지 계속 공개됩니다.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: "paragraph",
          text: "영국 및 EU 개인정보 보호 법률에 따라 귀하는 자신의 개인정보에 대한 열람, 정정, 삭제 또는 이동(내보내기)을 요청할 수 있고, 특정 처리에 대하여 이의를 제기하거나 처리 제한을 요청할 수 있으며, 언제든지 동의를 철회할 수 있습니다. 또한 귀하의 개인정보 감독기관(영국의 경우 ICO)에 민원을 제기할 수 있습니다. 일부 결제 및 세무 기록은 귀하가 삭제를 요청하더라도 보관되어야 합니다.",
        },
      ],
    },
    {
